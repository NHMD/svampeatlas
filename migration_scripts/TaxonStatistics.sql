...
ALTER TABLE TaxonStatistics ADD INDEX  (`accepted_count`), 
ADD INDEX  (`total_count`), 
ADD INDEX  (`accepted_count_before_atlas`),
ADD INDEX  (`accepted_count_during_atlas`),
ADD INDEX  (`accepted_count_after_atlas`),
ADD INDEX  (`last_accepted_record`),
ADD INDEX  (`first_accepted_record`);
...
-- første fund
 ...
 -- seneste fund
   ...
   ON DUPLICATE KEY UPDATE updatedAt=NOW(), 	last_accepted_record=a.maxdate;
	   ...
	   CREATE EVENT stats_daily
	       ON SCHEDULE
	         EVERY 1 DAY
	   	  STARTS '2016-12-03 04:00:00'
