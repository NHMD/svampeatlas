...
var all = {
  ...
  google: {
	...
	maps : {
		...
		elevation_key: 'AIzaSyAMVRdm_l_O1rgg4u2EeEQMlluLWCME_Mg'
	}
  },
  ...
  redisTTL: {
	  ...
	  count: 60 * 60 * 24,
	  votesCommunityApproved26weeks: 60 * 60 * 24,
	  votesExpertApproved26weeks: 60 * 60 * 24,
	  votesNotApproved26weeks: 60 * 60 * 24,
	  dataSet : 60 * 60 * 24,
	  imageCount: 60 * 60 * 24,
	  userCount: 60 * 60 * 24,
	  speciesCount: 60 * 60 * 24,
	  observationUserCount:  60 * 60 * 24,
	  observationSpeciesCommunityApproved: 60 * 60 * 24,
	  observationSpeciesExpertApproved: 60 * 60 * 24,
	  observationSpeciesNotApproved: 60 * 60 * 24,
	  observationSpecies: 60 * 60 * 24,
	  votesCommunityApproved: 60 * 60 * 24,
	  votesExpertApproved: 60 * 60 * 24,
	  votesNotApproved: 60 * 60 * 24,
	  votes: 60 * 60 * 24
  },
  mail: {
