...
var dnaSequenceController = require('../DnaSequence/DnaSequence.controller');
...
router.post('/:id/dnasequence', auth.hasRole('taxonomyadmin'), dnaSequenceController.addDnaSequenceToObs);
router.get('/:id/dnasequence', auth.hasRole('taxonomyadmin'), dnaSequenceController.showDnaSequencesForObs);
